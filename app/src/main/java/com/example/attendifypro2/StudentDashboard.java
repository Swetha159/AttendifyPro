...
public class StudentDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Lobbies");
    ...
    private void loadJoinedLobbies() {
        ...
        DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("Students").child(userId).child("joinedLobbies");
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot lobbySnapshot : snapshot.getChildren()) {
                    ...
                    DatabaseReference lobbyRef = FirebaseDatabase.getInstance().getReference("Lobbies").child(lobbyCode);
    ...
    private void joinLobby() {
        ...
        lobbyRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    String userId = firebaseAuth.getCurrentUser().getUid();
                    DatabaseReference studentRef = FirebaseDatabase.getInstance().getReference("Students").child(userId).child("joinedLobbies").child(lobbyCode);
